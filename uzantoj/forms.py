...
class UzantoCreateForm(forms.ModelForm):
    ...
    def clean(self):
        cleaned_data = super(UzantoCreateForm, self).clean()
        pasvorto1 = cleaned_data.get("pasvorto1")
        pasvorto2 = cleaned_data.get("pasvorto2")
...
class CustomUserChangeForm(UserChangeForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            "jabber", "skype", "twitter", "retejo",
            "adreso", "adreso2", "posxtkodo", "urbo", "lando",
            "tel", "tel2",
        ]
